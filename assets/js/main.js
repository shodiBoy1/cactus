...
const blurHeader = () => {
  ...
  // Add a class if the bottom offset is grater than 50 of the viewport height
...
const scrollUp = () => {
  ...
  // when the scroll is higher than 350 viewport hieght, add the show-scroll class to the a tag with the scroll-top class
